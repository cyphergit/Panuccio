...
<script type="text/javascript">
  function deleteRow(r) {
			...
			if (answer){
				...
				$("#delete-wrap").append('<form name="deleteForm" id="deleteForm" action="common/q_deletePreownedImg.php" method="post"><input id="entryID" name="entryID" type="hidden" value="' + content + '"/></form>');
