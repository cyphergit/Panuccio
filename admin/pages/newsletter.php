...
<script type="text/javascript">
  function deleteRow(r) {
			...
			if (answer){
				...
				$("#delete-wrap").append('<form name="deleteForm" id="deleteForm" action="common/q_deleteNewsletter.php" method="post"><input id="entryID" name="entryID" type="hidden" value="' + content + '"/></form>');
  ...
  function LoadViewDialog(r) {
      ...
      //window.open('http://localhost/Panuccio/admin/views/view_newsletter.php','newsletterWindow','width='+ popW +',height='+ popH +',top=' + topPos +',left=' + leftPos +',resizable=yes,scrollbars=yes');
      window.open('http://www.panuccioautos.com.au/admin/views/view_newsletter.php','newsletterWindow','width='+ popW +',height='+ popH +',top=' + topPos +',left=' + leftPos +',resizable=yes,scrollbars=yes');
...
<div>
  <?php include('includes/cypher_newsletter_table.php');?>
</div>
