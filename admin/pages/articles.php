...
<script type="text/javascript">
  function deleteRow(r) {
			...
			if (answer){
				...
				$("#delete-wrap").append('<form name="deleteForm" id="deleteForm" action="common/q_deleteArticle.php" method="post"><input id="entryID" name="entryID" type="hidden" value="' + content + '"/></form>');
  ...
  function LoadUpdateDialog(r) {
      ...
      //window.open('http://localhost/Panuccio/admin/views/view_article.php','articleWindow','width='+ popW +',height='+ popH +',top=' + topPos +',left=' + leftPos +',resizable=yes,scrollbars=yes');
      window.open('http://www.panuccioautos.com.au/admin/views/view_article.php','articleWindow','width='+ popW +',height='+ popH +',top=' + topPos +',left=' + leftPos +',resizable=yes,scrollbars=yes');
...
<div>
  <?php include('includes/cypher_article_table.php');?>
</div>
